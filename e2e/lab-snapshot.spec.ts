...
test("lab fullart cards — visual snapshot", async ({ page }) => {
  ...
  const charizard = page.locator(".card-frame").nth(4);
  ...
  const lunala = page.locator(".card-frame").nth(0);
  ...
  const meow = page.locator(".card-frame").nth(2);
  ...
  const flyingPika = page.locator(".card-frame").nth(6);
  ...
  const surfingPika = page.locator(".card-frame").nth(7);
  ...
  const charizardVstar = page.locator(".card-frame").nth(8);
  ...
  const volcanion = page.locator(".card-frame").nth(9);
