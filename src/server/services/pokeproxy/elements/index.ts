...
export function createDefaultElements(): CardElement[] {
  return [
    ...
    new PackedRowElement("attack-1", { anchorX: 20, anchorY: 530, direction: "ltr", width: 710, paddingTop: 4, paddingRight: 8, paddingBottom: 4, paddingLeft: 8, fill: "#333333", fillOpacity: 0.1, rx: 5 }, [
