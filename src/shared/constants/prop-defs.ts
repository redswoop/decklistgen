...
export const PROP_DEFS: Record<string, PropDef[]> = {
  box: [
    ...
    { key: "skewX", label: "Skew X (deg)", type: "number", min: -30, max: 30, step: 1, group: "appearance" },
    { key: "filter", label: "Filter", type: "select", options: ["none", "glass-blur"], group: "appearance" },
    { key: "blurRadius", label: "Blur Radius", type: "number", min: 1, max: 40, step: 1, group: "appearance" },
    { key: "fillGradient", label: "Fill Gradient", type: "text", group: "appearance" },
  ],
  image: [
    { key: "anchorX", label: "Anchor X", type: "number", min: -200, max: 900, step: 1, isPosition: true, group: "position" },
    { key: "anchorY", label: "Anchor Y", type: "number", min: -200, max: 1100, step: 1, isPosition: true, group: "position" },
...
export const SUB_PROP_DEFS: Record<string, PropDef[]> = {
  text: [
    ...
    { key: "fontStyle", label: "Style", type: "select", options: ["normal", "italic"], group: "appearance" },
    { key: "fill", label: "Fill", type: "color" },
